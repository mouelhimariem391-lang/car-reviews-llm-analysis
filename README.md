...
Analyse de sentiment — classifier automatiquement les avis clients comme positifs ou négatifs



Traduction automatique — traduire un extrait d'avis de l'anglais vers l'espagnol pour les nouveaux marchés



Question-réponse — extraire une réponse précise à une question posée sur un avis



Résumé automatique — condenser un avis long en quelques phrases
